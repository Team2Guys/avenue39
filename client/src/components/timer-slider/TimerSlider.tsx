                ...
                <div className="relative flex lg:flex-row flex-col justify-between h-full items-center lg:py-0 py-10 ">
                  <div className="w-full lg:px-28 px-5 text-left lg:flex lg:flex-col text-primary lg:order-1 order-2 lg:pt-0 pt-10">
                    <div className='lg:px-3'>
                      <h3 className="text-black text-18 font-bold tracking-[6px] lg:mb-3">{slide.discountText}</h3>
                      <h3 className="lg:text-6xl text-2xl lg:font-bold mb-6 text-[#FF0000] ml-[-5px]">{slide.dealText}</h3>
                        ...
                        <div className="flex flex-col items-center">
                          <span className="lg:text-6xl text-lg font-light">
                            ...
                            <span className="lg:text-lg text-xs italic opacity-50 align-sub font-normal">
                              <span className="lg:text-4xl text-xs font-normal opacity-50">/</span> Days
                            </span> <span className='opacity-50 '>:</span>
                          </span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="lg:text-6xl text-lg font-light">
                            {hours}
                            <span className="lg:text-lg text-xs italic opacity-50 align-sub font-normal">
                              <span className="lg:text-4xl text-xs font-light opacity-50">/</span> Hours
                            </span> <span className='opacity-50 '>:</span>
                          </span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="lg:text-6xl text-lg font-light">
                            {minutes}
                            <span className="lg:text-lg text-xs italic opacity-50 align-sub font-normal">
                              <span className="lg:text-4xl text-xs font-light opacity-50">/</span> Mins
                            </span> <span className='opacity-50 '>:</span>
                          </span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="lg:text-6xl text-lg font-light">
                            {seconds}
                            <span className="lg:text-lg text-xs italic opacity-50 align-sub font-normal">
                              <span className="lg:text-4xl text-xs font-light opacity-50">/</span> Secs
                            </span>
                          </span>
                        </div>
                      </div>
